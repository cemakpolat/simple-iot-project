...
* [CoreUI Free Angular Admin Template](https://github.com/coreui/dashboard)
...
- [Download the latest release](https://github.com/coreui/dashboard/)
- Clone the repo: `git clone https://github.com/coreui/dashboard.git`
...
See [the Releases section of our project](https://github.com/coreui/dashboard/releases) for changelogs for each release version.
...
Code released under [the MIT license](https://github.com/coreui/dashboard/blob/master/LICENSE).
...
# Frontend
Mostly used link: https://bugfender.com/blog/using-mqtt-on-angular-apps/
